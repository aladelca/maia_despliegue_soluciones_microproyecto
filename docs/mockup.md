# Mockup de la pantalla de predicción
    ...
    | Informational duration [ 0 ]       | OS / Browser / Region |
    | Product related [ 1 ]             | Traffic type          |
    | Product duration [ 0 ]            | Special day [ 0.0 ]   |
    | Bounce / Exit / Page value        |                       |
    +------------------------------------+-----------------------+
    |                    [ Predecir compra ]                     |
    +------------------------------------------------------------+
    | Resultado: compra probable                                 |
    | Probabilidad 73%  [======================-------]           |
    | Tasa base 15.5%  [=====--------------------------]          |
    | Umbral 50% · Modelo <versión>                               |
    +------------------------------------------------------------+
